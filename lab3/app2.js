...
function hienThiMenu() {
 console.log("MENU<br>");
 console.log("1. Tính điểm trung bình (switch case)<br>");
 console.log("2. Tính điểm trung bình (if else)<br>");
 console.log("0. Thoát<br>");
}
...
function chayChuongTrinh() {
  while (true) {
    hienThiMenu();
    let luaChon = parseInt(prompt("Nhập lựa chọn của bạn 0, 1 hoặc 2:"));
